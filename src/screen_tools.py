...
MPC_ANGLE_ERROR_POS        = (790, 800)
MPC_DISPLACEMENT_ERROR_POS = (1240, 800)
...
def draw_static_screen(screen:pygame.display):
    ...
    pygame.draw.rect(screen, (255, 255, 255), (MPC_ANGLE_ERROR_POS[0], MPC_ANGLE_ERROR_POS[1], DISPLAY_LENGTH, DISPLAY_HEIGHT))
    pygame.draw.rect(screen, (255, 255, 255), (MPC_DISPLACEMENT_ERROR_POS[0], MPC_DISPLACEMENT_ERROR_POS[1], DISPLAY_LENGTH, DISPLAY_HEIGHT))
